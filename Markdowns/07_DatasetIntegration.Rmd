...
## Why do we need Data Integration and Batch Correction?
...
Have a go at running the data integration and batch corrections on the data we have generated so far from the previous weeks. You should find a file in RObjects called `` which contains the data processed up until this point if you haven't got that far yet.

Import your data and have a look at it uncorrected.
