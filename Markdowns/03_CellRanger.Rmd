...
of these features such as gene names, gene IDs etc. Each gene will have 
...
"attributes" column of the gtf the three critical tags for the Cell Ranger
...
fasta file we create one chromosome/contig for each gene. For the gtf we
...
We will be a piece of software called "Clarity Tools" to retrieve the data from
