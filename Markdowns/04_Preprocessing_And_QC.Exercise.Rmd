...
In the course materials we performed QC and filtering of 1 sample from each
...
HHD, PBMMC, PRE-T) (batch=sce\$SampleGroup), or we could apply it per sample (batch=sce$Sample)
</details>
