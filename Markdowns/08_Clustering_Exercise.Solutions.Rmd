...
```{r}
plotTSNE(sce, 
         colour_by = "k.57_cluster.fun.leiden") +
...
There's lots of ribosomal genes here. Let's check the expression of a few:
...
On the otherhand we do have **CD3D**, **CD3E** and **TRAC**, which are T-cell markers,
and **IL32**, which is an indicator of T-cell activation.

Let's take a look at these:


```{r}
plotTSNE(sce, by_exprs_values = "reconstructed",
               colour_by = "CD3D",
               text_by = "k.60_cluster.fun.leiden")
...
**IL32**, **NKG7**, **GZMA** and **GNLY** might suggest that these are activated
NK cells or perhaps NKT cells?
...
Let's have a look at a couple of additional NK marker genes.
